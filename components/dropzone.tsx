  ...
  return (
    ...
    >
      {({ getRootProps, getInputProps }) => (
        <div
  {...getRootProps()}
  className="bg-transparent h-72 lg:h-80 xl:h-96 rounded-3xl shadow-sm border-2 border-dashed cursor-pointer flex items-center justify-center"
>
  <input {...getInputProps()} />
    ...
    {is_hover ? (
      <>
        <div className="justify-center flex text-6xl">
          <LuFileSymlink style={{ color: "#FFFFFF" }}/>
        </div>
      ...
      <>
        <div className="justify-center flex text-6xl ">
          <FiUploadCloud style={{ color: "#FFFFFF" }} />
        </div>
        <h3 className="text-center font-medium text-2xl text-white">
